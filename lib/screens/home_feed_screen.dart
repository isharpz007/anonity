...
class _HomeFeedScreenState extends State<HomeFeedScreen> {
  ...
  List<AppPost> get _visiblePosts {
    if (_tabIndex <= 1) return mockFeedPosts;
    final section = _tabs[_tabIndex];
    return mockFeedPosts.where((p) => p.section == section).toList();
  }
            ...
            child: ListView(
              ...
              children: [
                ...
                if (_visiblePosts.isEmpty)
                  ...
                  for (final post in _visiblePosts) PostCard(post: post),
              ],
            ),
          ),
        ],
